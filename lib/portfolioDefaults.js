...
export const PORTFOLIO_DEFAULTS = {
  ...
  projects: [
    ...
    },
    {
      ...
      type: "QA Automation · Personal Project",
      ...
      caseStudy: {
        ...
        result:
          "A small, actively developed project: the suite covers 127 tests across 14 files spanning every core part of the app, and has already found 9 real, documented bugs — including one shared styling issue affecting 8 different sections. No usage numbers beyond that.",
      },
      screenshots: [],
    },
    {
      ...
      caseStudy: {
        ...
        result:
          "Early-stage but real: built by a team of around five, with two tagged releases and an active development branch. It isn't live yet, so there are no traffic or conversion numbers to report.",
      },
      screenshots: [],
    },
    {
