/**
 * lib/openai.js — Gemini wrapper and prompt builder for Kaia.
...
const RETRY_BASE_MS = parseInt(process.env.OPENROUTER_RETRY_BASE_MS || "800", 10);
const RETRY_MAX_DELAY_MS = parseInt(process.env.OPENROUTER_MAX_RETRY_DELAY_MS || "5000", 10);
