      ...
      <div ref={sectionRef} className="section-reveal">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="space-y-4 text-text-muted text-base leading-relaxed">
              <p>
                ...
                production MVP systems. I specialize in Laravel and CodeIgniter, with a
                genuine interest in the full product lifecycle — from database design
                to user interaction.
              </p>
              <p>
                Beyond the backend, I bring a strong UI/UX background that lets me
                think about systems from the user&apos;s perspective. I&apos;ve contributed to
                reimbursement platforms, AI-driven profile tools, workflow systems,
                and hospital interfaces — primarily at SoftwareSeni.
              </p>
              <p>
          ...
          <div className="space-y-4">
            <InfoRow label="Location" value="Yogyakarta, Indonesia" />
            <InfoRow label="Currently" value="Software Developer @ SoftwareSeni" />
            <InfoRow label="Education" value="Informatics, Ahmad Dahlan University — GPA 3.82" />
            <InfoRow label="Focus" value="Laravel · CodeIgniter · AI Systems · UI/UX" />
            <InfoRow label="Languages" value="Bahasa Indonesia (Native) · English (Intermediate)" />
          </div>
        </div>
      </div>
    </section>
