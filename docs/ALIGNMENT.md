...
| Replace bit.ly links with direct Figma URLs (3 UX projects) | 🔲 Blocked | bit.ly is blocked by this environment's egress proxy — can't resolve the redirects. Needs the real Figma URLs supplied directly. |
